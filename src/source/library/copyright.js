...
exports.checkFingerprint = (hash) =>{
    return new Promise( async (resolve, rejects) => {
      request.get(`https://ipfs.jumu.tk/ipfs/${hash}`, async function (err, res, fileBuffer) {
...
// request.get('https://ipfs.jumu.tk/ipfs/QmUzvaqtvvnCmkTmTNRYQJsnFfi3PFFnQr6jABbgfeMSXy', async function (err, res, fileBuffer) {
//     //process exif here
