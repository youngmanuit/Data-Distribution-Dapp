    ...
    return (
      <div>
        ...
        >
          ...
          <TextText title='Total Offer Amount' content={formatThousands(record.offerAmount) + ' DIV'}/>
          <TextText title='Total Offer Percent' content={parseFloat(record.offerPercent / 1000).toFixed(3) + '%'}/>
          <TextText title='Amount Remaining' content={formatThousands(record.amountRemaining) + ' DIV'}/>
